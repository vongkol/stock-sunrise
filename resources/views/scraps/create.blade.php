...
<form>
    <div class="card card-gray">
        <div class="toolbox">
            ...
            <a href="{{url('scrap')}}" class="btn btn-warning btn-sm btn-oval">
            ...
            <div class="row">
               <div class="col-sm-6">
                    <div class="form-group row">
                        <label for="scrap_date" class="col-sm-3">Scrap Date <span class="text-danger">*</span></label>
                        <div class="col-sm-9">
                            <input type="date" class="form-control" id="scrap_date">
                        </div>
                    </div>
               </div>
               <div class="col-sm-6">
...
@section('js')
    ...
    <script src="{{asset('js/scrap.js')}}"></script>
    <script>
